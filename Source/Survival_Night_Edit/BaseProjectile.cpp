...
ABaseProjectile::ABaseProjectile()
{
	...
	// Set Projectile Movement Components
	if (!ProjectileMovementComponent)
	{
		//Values for Projectile Movement
	...
	// Initialize Visual Projectile Representation
	...
	// Initialize Visual Material for projectile mesh
